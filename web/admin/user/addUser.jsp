                    ...
                    <tr>
                        ...
                        <td width="80%" height="20" bgcolor="d3eaef" class="STYLE6">
                            <div
                                ...
                                <input type="text" name="nickname" placeholder="昵称" value="${msg.nickname}"
                                       required="required"/>
                    ...
                    <tr>
                        ...
                        <td width="80%" height="20" bgcolor="d3eaef" class="STYLE6">
                            <div
                                ...
                                <input type="text" name="password" placeholder="密码" value="${msg.password}"
                                       required="required"/>
                    ...
                    <tr>
                        ...
                        <td width="80%" height="20" bgcolor="d3eaef" class="STYLE6">
                            <div
                                ...
                                <input type="text" name="email" placeholder="邮箱" value="${msg.email}"
                                       required="required"/>
                    ...
                    <tr>
                        ...
                        <td width="80%" height="20" bgcolor="d3eaef" class="STYLE6">
                            <div
                                ...
                                <input type="text" placeholder="出生日期" name="birthday" value="${msg.birthday}"
                                       size="15"/>
							格式：yyyy-MM-dd
                            </div>
                        </td>
