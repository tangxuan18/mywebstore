							...
							<table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
								<tr>
									<td width="49">
										<div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/userServlet?op=findPageUsers&num=1">首页</a>
											</span>
										</div>
									</td>
									<td width="49">
...
<c:if test="${page.currentPageNum != 1}">
											<a href="${pageContext.request.contextPath }/userServlet?op=findPageUsers&num=${page.prevPageNum}">上一页</a>
</c:if>
											</span>
										</div>
									</td>
...
<c:if test="${page.currentPageNum != page.totalPageNum}">
											<a href="${pageContext.request.contextPath }/userServlet?op=findPageUsers&num=${page.nextPageNum}">下一页</a>
</c:if>
											</span>
										</div>
									</td>
									<td width="49">
										<div align="center">
											<span class="STYLE22"><a href="${pageContext.request.contextPath }/userServlet?op=findPageUsers?op=findAllUser&num=${page.totalPageNum }">尾页</a></span>
										</div>
									</td>
	...
	<script type="text/javascript">
		...
		function jump() {
			...
			window.location.href = "${pageContext.request.contextPath }/userServlet?op=findPageUsers&num="
					+ num;
