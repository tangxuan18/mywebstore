                    ...
                    <c:forEach items="${requestScope.admins}" var="admin">
                        <tr>
                            <td height="20" bgcolor="#FFFFFF">
                                <div align="center">
                                    <input type="checkbox" name="aid" id="aid" value="${admin.id}"/>
                                </div>
                            </td>
                            <td height="20" bgcolor="#FFFFFF" class="STYLE6">
                                <div align="center">
                                    <span class="STYLE19">${admin.id}</span>
                                </div>
                            </td>
                                    ...
                                    <td width="49">
                                        <div align="center">
                                            <span class="STYLE22"><a
                                                    href="${pageContext.request.contextPath }/AdminServlet?op=findAllAdmin&num=${page.totalPageNum }">尾页</a></span>
                                        </div>
                                    </td>
...
<script type="text/javascript">
    ...
    function jump() {
        ...
        window.location.href = "${pageContext.request.contextPath }/admin/categoryServlet?op=findAllCategory&num=1" + num;
