					...
					<c:forEach items="${page.list }" var="order">
						<tr>
							<td height="2" bgcolor="#FFFFFF">
								<div align="center">
									<input type="checkbox" name="pid" id="pid" value="${order.orderId }" />
								</div>
							</td>
							<td height="15" bgcolor="#FFFFFF" class="STYLE6">
								<div align="center">
									<span class="STYLE19">${order.orderId}</span>
								</div>
							</td>
							...
							<td height="10" bgcolor="#FFFFFF">
								<div align="center" class="STYLE21">
									...
									<a href="${pageContext.request.contextPath }/orderServlet?op=orderDetail&oid=${order.orderNum}">查看</a>
								</div>
							</td>
					</tr>
					</c:forEach>
...
<c:if test="${page.currentPageNum != page.totalPageNum}">
									...
									<td width="49">
										<div align="center">
											<span class="STYLE22"><a href="${pageContext.request.contextPath }/orderServlet?op=findPageOrders&num=${page.totalPageNum }">尾页</a></span>
										</div>
									</td>
