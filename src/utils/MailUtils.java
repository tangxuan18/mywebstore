...
public class MailUtils {
    public static boolean sendMail(String email, String emailMsg) {
        ...
        String from = "tangxuan20141402@163.com"; 			// 邮件发送人的邮件地址
        String to = email; 								// 邮件接收人的邮件地址
        final String username = "tangxuan20141402@163.com";  	//发件人的邮件帐户
        final String password = "WY199611";   			//发件人的邮件密码（不同于登录密码，需要单独设置）
